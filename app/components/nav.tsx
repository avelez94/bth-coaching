  ...
  return (
    <>
      <style>{`
        ...
        .nav-link { font-size: 0.72rem; color: #6B7A8D; text-decoration: none; letter-spacing: 0.06em; text-transform: uppercase; transition: color 0.2s; font-weight: 500; white-space: nowrap; }
        .nav-link:hover { color: #0D1B2A; }
        .nav-cta { background: #0D1B2A; color: #F7F4ED; padding: 12px 24px; font-size: 0.68rem; letter-spacing: 0.08em; text-transform: uppercase; text-decoration: none; transition: all 0.3s; font-weight: 500; white-space: nowrap; }
        ...
        .nav-mobile { display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: #F7F4ED; z-index: 99; flex-direction: column; align-items: center; justify-content: center; gap: 28px; }
        .nav-mobile.open { display: flex; }
        .nav-mobile a { font-size: 1.3rem; color: #0D1B2A; text-decoration: none; font-family: 'Playfair Display', serif; font-weight: 700; }
      ...
      <div className="nav-wrap" style={{background: scrolled ? 'rgba(247,244,237,0.98)' : 'rgba(247,244,237,0.95)'}}>
        <div className="nav-inner">
          ...
          <a href="/contact" className="nav-cta">Schedule Your Free Intro Call</a>
      ...
      <div className={`nav-mobile ${menuOpen ? 'open' : ''}`}>
        ...
        <a href="/contact" className="nav-mobile-cta" onClick={() => setMenuOpen(false)}>Schedule Your Free Intro Call</a>
      </div>
    </>
  )
}