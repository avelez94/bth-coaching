...
const pillars = [
  {
    ...
    address: 'Character, integrity & values-aligned decisions',
    desc: 'A leader without a clearly articulated ethical framework will be caught flat-footed by decisions that require one. Under pressure, in ambiguous situations, with competing demands — character is what remains when everything else falls away. This pillar addresses character, not compliance. Not what the rules require, but who you are when the rules don\'t cover it.',
  },
  {
    num: '02',
    name: 'Professional Excellence',
    address: 'Craft, credibility & continued development',
    desc: 'At the executive level, credibility is currency — and it requires active stewardship. Continued, deliberate investment in the knowledge, skills, and capabilities specific to your domain and your leadership role. It also means the willingness to recognize when current approaches are no longer sufficient — and to act on that recognition rather than defaulting to what has always worked.',
  },
  {
    num: '03',
    name: 'Physical Health & Readiness',
    address: 'Energy, endurance & cognitive capacity',
    desc: 'Physical condition is the biological substrate of professional performance. Research on sleep deprivation alone demonstrates measurable impairment of the prefrontal cortex at levels most executives routinely accept as normal. Chronic depletion impairs exactly the capabilities leadership demands most. This pillar is not about fitness culture. It is about the infrastructure that makes sustained, high-quality leadership possible.',
  },
  {
    num: '04',
    name: 'Financial Stewardship',
    address: 'Stability & freedom from cognitive load',
    desc: 'Financial stress impairs executive function. A 2013 study in Science demonstrated that financial worry occupies working memory in a way that produces cognitive performance drops equivalent to losing significant sleep — not because the person is less capable, but because a portion of their cognitive bandwidth is already consumed. A senior leader carrying unresolved financial stress carries it into every organizational decision they make, often without knowing it.',
  },
  {
    num: '05',
    name: 'Cognitive Fortitude',
    address: 'Clarity & sound judgment under pressure',
    desc: 'The capacity to think clearly and make sound judgments under sustained pressure is not a fixed trait — it is a developable capability. The leaders who perform well under pressure have built specific cognitive habits and frameworks for managing their own thinking. This pillar addresses those habits: how you interpret setbacks, manage uncertainty, and maintain strategic perspective when the situation is loud and demanding.',
  },
  {
    num: '06',
    name: 'Emotional Equanimity',
    address: 'Regulation, presence & culture impact',
    desc: 'How a leader shows up emotionally is the primary driver of organizational culture. Not suppressing emotion — intelligently managing emotional experience. The capacity to feel difficulty without being governed by it. Research on emotional contagion demonstrates that a leader\'s emotional state is transmitted through a team — affecting cognitive performance, risk tolerance, and creativity of the people around them.',
  },
  {
    num: '07',
    name: 'Relational Harmony',
    address: 'Trust & connection at work and at home',
  ...
  },
  {
    ...
    address: 'Culture, values alignment & contextual fit',
...
const phases = [
  {
    label: 'Phase 0',
    sub: 'Intake & Orientation',
    body: 'A self-administered intake survey, followed by a 1–2 day intro session (in-person or virtual): relationship-building, expectations, and a first look at where you stand across all 8 Pillars.',
  },
  {
    label: 'Months 1–8',
    sub: 'One Pillar per Month',
    body: 'Two sessions each month, as described above. First a dive into the Pillar, next an open session to address your most pressing challenges or explore the pillars more fully.',
  },
  {
    label: 'Months 9–10',
    sub: 'Close-Out',
    body: 'Ongoing coaching and lessons learned across all 8 Pillars, a plan for what you sustain on your own, and — if it\'s a fit — an introduction to ongoing support between engagements.',
  },
]

const tracks = [
  {
    track: 'Individual / Executive Track',
    audience: 'Self-directed individuals and executives',
    price: '$6,000',
    note: 'The full 10-month arc, all-inclusive. No per-session billing.',
  },
  {
    track: 'Team / Cohort Track',
    audience: 'Teams and cohorts',
    price: 'Custom',
    note: 'Custom-scoped based on cohort size. Pillar Sessions typically delivered once per month to the full cohort; Coaching Sessions remain one-on-one per participant. Contact us for a per-person quote once your cohort size is set.',
  },
  {
    track: 'Organization-Wide Track',
    audience: 'Organizations',
    price: 'Custom SOW',
    note: 'Scoped to your organization\'s structure and goals — similar to our Leadership Consulting engagements.',
  },
]
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ============================================================
           1. HERO
           Ivory. Quieter open than the slate heroes on service pages.
           Program name reads as context not as eyebrow.
        ============================================================ */
        .hero {
        ...
        /* ============================================================
           ...
           Ivory dark. Single column, centered. Headline arrives on scroll.
        ============================================================ */
        .positioning {
        ...
        .positioning-body.visible {
          opacity: 1;
          transform: translateX(0);
        }

        /* ============================================================
           3. SCIENCE — asymmetric split
           Slate pale. Evidence left, authority statement right.
        ============================================================ */
        .science {
        ...
        /* ============================================================
           4. PILLARS — interactive index + single display area
           Ivory. Eight pillar names as navigation. One content panel.
           Keyboard accessible. Mobile collapses to accordion.
        ============================================================ */
        .pillars {
          background: var(--ivory);
          padding: 100px 72px;
        ...
        /* Desktop: side-by-side index + panel */
        .pillars-layout {
          display: grid;
        ...
        .pillar-index-item:focus-visible {
          outline: 2px solid var(--slate);
          outline-offset: -2px;
        }
        .pillar-index-item.active {
          background: var(--ivory-dark);
        }
        .pillar-index-item:hover:not(.active) {
        ...
        /* ============================================================
           5. TWO-SESSION STRUCTURE
           Slate. Asymmetric split — equal conceptual weight, different
           visual character. Vertical rule divides them.
        ============================================================ */
        .sessions {
          background: var(--slate);
          padding: 100px 72px;
        ...
        /* ============================================================
           6. PROGRAM ARC — horizontal timeline on desktop
           Ivory dark. Horizon line connects three phases.
           Vertical on mobile.
        ============================================================ */
        .arc {
          background: var(--ivory-dark);
        ...
        .arc-track::before {
          ...
          right: 20px;
          height: 1px;
          background: linear-gradient(to right, var(--slate) 0%, var(--slate-light) 50%, var(--slate) 100%);
          opacity: 0.35;
        }
        .arc-phase {
          padding: 0 32px 0 0;
        ...
        .arc-phase:last-child { padding-right: 0; }
        /* Node on the line */
        .arc-node {
          width: 8px;
          height: 8px;
        ...
        /* ============================================================
           7. CONFIDENTIALITY
           Ivory. Narrow measure, whitespace only. No decoration.
        ============================================================ */
        .confidentiality {
          background: var(--ivory);
          padding: 80px 72px;
        ...
        /* ============================================================
           8. INVESTMENT — editorial row list
           Ivory dark. Typography + spacing, no tier cards.
        ============================================================ */
        .investment {
          background: var(--ivory-dark);
          padding: 100px 72px;
        ...
        @media (max-width: 1024px) {
          ...
          .science-authority { text-align: left; }
          ...
          .arc-track { grid-template-columns: 1fr; gap: 0; position: relative; }
          .arc-track::before { top: 0; left: 3px; bottom: 0; width: 1px; height: auto; right: auto; opacity: 0.35; }
          .arc-phase { padding: 0 0 40px 28px; border-bottom: none; position: relative; }
          .arc-phase:last-child { padding-bottom: 0; }
          .arc-node { position: absolute; left: -5px; top: 0; margin-bottom: 0; }
        ...
        @media (max-width: 640px) {
          ...
          .investment-track { grid-template-columns: 1fr; gap: 8px; }
          .track-price { text-align: left; }
        }
      `}</style>
      ...
      <section className="investment">
        <div className="investment-inner">
          ...
          <div className="investment-tracks">
            {tracks.map((t, i) => (
              <div key={i} className="investment-track">
                <div>
...
/* ============================================================
   POSITIONING SECTION — separate component for scroll animation
============================================================ */
function PositioningSection() {
  ...
  useEffect(() => {
    ...
    bodyRefs.current.forEach(el => { if (el) observer.observe(el) })
  ...
  return (
    <section className="positioning">
      <div className="positioning-inner">
        <h2 className="positioning-headline" ref={headlineRef}>
          Most programs develop skills. This one develops leaders.
        </h2>
        {[
          "Leadership training typically addresses competencies and behaviors. Those matter. But they miss the most common reason leaders underperform, burn out, or plateau: compromise in the whole person.",
          "The immediate challenge a leader faces is rarely the whole story. The weight they carry professionally has company somewhere else — financial stress, relational friction, physical depletion, a culture that doesn't fit. Addressing only the professional surface produces partial results. Most programs never look underneath.",
          "The Mission-Ready Leadership Program starts where most programs stop.",
        ].map((para, i) => (
          <p
            key={i}
            className="positioning-body"
